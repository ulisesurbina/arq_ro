...
import { Music2, X as XIcon } from "lucide";
import { project } from "../data/project";
import { InstagramIcon, FacebookIcon } from "./SocialIcons";
import { trackEvent } from "../lib/analytics";

// Cada red es opcional: si el link viene vacío en project.js, no se renderiza.
const SOCIALS = [
  ...
  return (
    <footer className="bg-grafito-900 border-t border-white/10">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <a
          href="/#top"
          className="text-xs font-mono uppercase tracking-[0.14em] text-grafito-300 hover:text-azul-300 transition-colors"
        >
          Volver arriba ↑
        </a>
      </div>
