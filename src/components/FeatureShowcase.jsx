...
export default function FeatureShowcase() {
  return (
    <section id="detalles" className="bg-azul-950">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-4 text-azul-300">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {featureShowcase.map((item, i) => (
            <motion.article
              ...
              whileHover={{ y: -6 }}
              className={`group relative overflow-hidden rounded-2xl bg-azul-900 ring-1 ring-white/10 ${
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-azul-950 via-azul-950/25 to-transparent" />
